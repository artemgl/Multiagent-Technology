...
public class MainController {
    ...
    public void initAgents(FMatrixSparse adjacencyMtx) {
        ...
        try {
            for(int i = 0; i < numberOfAgents; i++) {
                AgentController agent = container.createNewAgent(String.valueOf(i), "ru.artemchernikov.mt.FindAverageAgent", args.get(i).toArray());
                agent.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
